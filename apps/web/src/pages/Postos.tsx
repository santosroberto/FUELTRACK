...
import { Plus, Pencil, Search, MapPin, Phone } from 'lucide-react'
import {
...
const mockPostos: Posto[] = [
  { id: '1', nome: 'Posto Shell', endereco: 'Av. Brasil, 1500', cidade: 'São Paulo', estado: 'SP', contato: '(11) 3333-1111' },
  { id: '2', nome: 'Auto Posto BR', endereco: 'Rua Augusta, 500', cidade: 'São Paulo', estado: 'SP', contato: '(11) 3333-2222' },
  { id: '3', nome: 'Posto Ipiranga', endereco: 'Av. Paulista, 2000', cidade: 'São Paulo', estado: 'SP', contato: '(11) 3333-3333' },
]

function PostoForm({ posto, onClose }: { posto?: Posto; onClose: () => void }) {
...
export function Postos() {
  ...
  const [editPosto, setEditPosto] = useState<Posto | undefined>()

  const filtrados = mockPostos.filter((p) =>
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={formAberto} onOpenChange={setFormAberto}>
          ...
          <DialogContent className="sm:max-w-lg">
            ...
            <PostoForm posto={editPosto} onClose={() => setFormAberto(false)} />
          </DialogContent>
        </Dialog>
      </div>
